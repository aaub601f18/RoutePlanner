...
namespace RoutePlanner
{
    public class Data
    {
        ...
        private string connStr = "server=127.0.0.1;user=root;database=mickpeder_bachelor;port=3306;password=P@ssw0rd";
...
/*
        public static Vertex GetVertex(string id)
        {
            try
            {
                ...
                res.Read();
                Vertex v = new Vertex(res[0].ToString(),Convert.ToDouble(res[1]), Convert.ToDouble(res[2])); 
